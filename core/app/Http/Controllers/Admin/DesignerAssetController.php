...
class DesignerAssetController extends Controller
{
    ...
    public function update(Request $request, Product $product)
    {
        $request->validate([
            ...
            'designer_settings.model_scale' => ['nullable', 'numeric', 'between:0.1,5'],
            'designer_settings.rotation_x' => ['nullable', 'numeric', 'between:-180,180'],
            'designer_settings.rotation_y' => ['nullable', 'numeric', 'between:-180,180'],
            'designer_settings.rotation_z' => ['nullable', 'numeric', 'between:-180,180'],
            'designer_settings.offset_x' => ['nullable', 'numeric', 'between:-3,3'],
            'designer_settings.offset_y' => ['nullable', 'numeric', 'between:-3,3'],
            'designer_settings.front_x' => ['nullable', 'numeric', 'between:-2,2'],
            'designer_settings.front_y' => ['nullable', 'numeric', 'between:-2,2'],
            'designer_settings.front_width' => ['nullable', 'numeric', 'between:0.2,2'],
            'designer_settings.front_height' => ['nullable', 'numeric', 'between:0.2,2'],
            'designer_settings.back_x' => ['nullable', 'numeric', 'between:-2,2'],
            'designer_settings.back_y' => ['nullable', 'numeric', 'between:-2,2'],
            'designer_settings.back_width' => ['nullable', 'numeric', 'between:0.2,2'],
            'designer_settings.back_height' => ['nullable', 'numeric', 'between:0.2,2'],
        ]);
