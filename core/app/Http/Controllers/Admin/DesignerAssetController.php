...
class DesignerAssetController extends Controller
{
    ...
    public function update(Request $request, Product $product)
    {
        $request->validate([
            ...
            'designer_settings.model_scale' => ['nullable', 'integer', 'between:1,5'],
            'designer_settings.rotation_x' => ['nullable', 'integer', 'between:-180,180'],
            'designer_settings.rotation_y' => ['nullable', 'integer', 'between:-180,180'],
            'designer_settings.rotation_z' => ['nullable', 'integer', 'between:-180,180'],
            'designer_settings.offset_x' => ['nullable', 'integer', 'between:-3,3'],
            'designer_settings.offset_y' => ['nullable', 'integer', 'between:-3,3'],
            'designer_settings.front_x' => ['nullable', 'integer', 'between:-2,2'],
            'designer_settings.front_y' => ['nullable', 'integer', 'between:-2,2'],
            'designer_settings.front_width' => ['nullable', 'integer', 'between:1,2'],
            'designer_settings.front_height' => ['nullable', 'integer', 'between:1,2'],
            'designer_settings.back_x' => ['nullable', 'integer', 'between:-2,2'],
            'designer_settings.back_y' => ['nullable', 'integer', 'between:-2,2'],
            'designer_settings.back_width' => ['nullable', 'integer', 'between:1,2'],
            'designer_settings.back_height' => ['nullable', 'integer', 'between:1,2'],
        ]);
