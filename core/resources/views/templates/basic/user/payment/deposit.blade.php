                                    ...
                                    @foreach ($gatewayCurrency as $data)
                                        <label for="{{ titleToKey($data->name) }}"
                                            ...
                                            <input class="payment-item__radio gateway-input" id="{{ titleToKey($data->name) }}" hidden
                                                data-gateway='@php echo json_encode($data) @endphp' type="radio" name="gateway" value="{{ $data->method_code }}"
                                ...
                                <div class="payment-system-list p-3">
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <strong class="text mb-0">@lang('Price')</strong>
                                        </div>
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                <span class="deposit-info__input-group-text">{{ showAmount($order->subtotal)  }} </span>
                                                <input type="hidden" class="form-control form--control"  value="{{ showAmount($order->subtotal, separate:false, currencyFormat:false) }}" readonly autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <strong class="text mb-0">@lang('Shipping Fee')</strong>
                                        </div>
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                <span class="deposit-info__input-group-text">{{ showAmount($order->shipping_fee) }} </span>
                                                <input type="hidden" class="form-control form--control" value="{{ showAmount($order->shipping_fee, separate:false, currencyFormat:false) }}" readonly autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <strong class="text mb-0">@lang('Subtotal')</strong>
                                        </div>
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                <span class="deposit-info__input-group-text">{{ showAmount($order->total_amount) }} </span>
                                                <input type="hidden" class="form-control form--control amount" name="amount"
                                                    placeholder="@lang('00.00')" value="{{ showAmount($order->total_amount, separate:false, currencyFormat:false) }}" readonly autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <strong class="text has-icon"> @lang('Limit')
                                                <span></span>
                                            </strong>
                                        </div>
                                        <div class="deposit-info__input">
                                    ...
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <strong class="text has-icon">@lang('Processing Charge')
                                    ...
                                    <div class="deposit-info total-amount pt-3">
                                        <div class="deposit-info__title">
                                            <strong class="text">@lang('Total')</strong>
                                        </div>
                                        <div class="deposit-info__input">
                                    ...
                                    <div class="deposit-info gateway-conversion d-none total-amount pt-2">
                                        <div class="deposit-info__title">
                                            <strong class="text">@lang('Conversion')
                                            </strong>
                                        </div>
                                        <div class="deposit-info__input">
                                            <p class="text"></p>
