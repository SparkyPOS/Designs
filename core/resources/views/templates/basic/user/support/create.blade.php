            ...
            <form action="{{ route('ticket.store') }}" class="disableSubmission" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="priority" class="form--control select2-basic" data-minimum-results-for-search="-1"
                            required>
...
@push('breadcrumb-plugins')
    <a href="{{ route('ticket.index') }}" class="btn btn--sm btn--base">
                    ...
                    <div class="col-lg-4 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group input--group">
                                ...
                                <button type="button" class="input-group-text removeFile bg--danger border--danger m-1"><i class="fas fa-times"></i></button>
                            </div>
                        </div>
                    </div>
                `)
