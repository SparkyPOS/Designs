...
@section('content')
    <form action="{{ route('vendor.withdraw.money') }}" method="post" class="withdraw-form">
        @csrf
        <div class="gateway-card">
            <div class="row justify-content-center gy-sm-4 gy-3">
                <div class="col-lg-6">
                    <div class="payment-system-list is-scrollable gateway-option-list border py-0 rounded">
                        @foreach ($withdrawMethod as $data)
                            <label for="{{ titleToKey($data->name) }}"
                                ...
                                <input class="payment-item__radio gateway-input" id="{{ titleToKey($data->name) }}" hidden
                                    data-gateway='@php echo json_encode($data) @endphp' type="radio" name="method_code"
                                    value="{{ $data->id }}" @checked(old('method_code', $loop->first) == $data->id)
                        ...
                        <div class="deposit-info">
                            ...
                            <div class="deposit-info__input">
                                <div class="input-group input--group">
                                    ...
                                    <input type="text" class="form-control form--control amount text-end" name="amount"
