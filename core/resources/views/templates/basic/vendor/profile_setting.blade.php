                    ...
                    <div class="setting-content mb-3">
                        <div class="setting-content__details">
                            <div class="user-profile d-flex flex-wrap flex-column flex-sm-row">
                                <div class="thumb">
                                    <img id="imagePreview" title="@lang('Upload Size') {{ getFileSize('vendorProfile')  }}"
                                        src="{{ getImage(getFilePath('vendorProfile') . '/' . $vendor->image, avatar: true) }}"
                                        data-src="{{ getImage(getFilePath('vendorProfile') . '/' . $vendor->image, avatar: true) }}"
                                ...
                                <div class="user-profile-content ms-3">
                                    <h3 class="title m-0">{{ $vendor->fullname }}</h3>
                                    <h5 class="title mb-2 text-muted">{{ $vendor->username }}</h5>
                                    <div class="user-profile__info d-flex flex-sm-column gap-2 gap-sm-1 flex-wrap">
                                        ...
                                        @if ($vendor->email)
                                            <div class="gap-2 d-flex">
                                                ...
                                                <span class="text">{{ $vendor->email }}</span>
                                            </div>
                                        @endif
                                        ...
                                        @if ($vendor->mobileNumber)
                                            <div class="gap-2 d-flex">
                                                ...
                                                <span class="text">{{ $vendor->mobileNumber }}</span>
                                            </div>
                                        @endif

                                        @if ($vendor->country_name)
                                            <div class="gap-2 d-flex">
                                                <span class="icon"><i class="las la-globe"></i></span>
                                                <span class="text">{{ $vendor->country_name }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form--control" name="firstname"
                                        value="{{ $vendor->firstname }}" required>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label class="form--label">@lang('Last Name')</label>
                                    <input type="text" class="form--control" name="lastname"
                                        value="{{ $vendor->lastname }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
