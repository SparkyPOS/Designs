            ...
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>@lang('User Callback URL')</label>
                            <div class="input-group">
                                <input type="text" class="form-control userCallback" readonly>
                        ...
                        <div class="form-group">
                            <label>@lang('Vendor Callback URL')</label>
                            <div class="input-group">
                                <input type="text" class="form-control vendorCallback" readonly>
                                <button type="button" class="input-group-text copyInput" title="@lang('Copy')">
                                    <i class="las la-clipboard"></i>
                                </button>
                            </div>
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                let vendorCallbackUrl = "{{ route('vendor.social.login.callback', '') }}";
                ...
                modal.find('.userCallback').val(`${callbackUrl}/${data.key}`);
                modal.find('.vendorCallback').val(`${vendorCallbackUrl}/${data.key}`);
                modal.modal('show');
            });
