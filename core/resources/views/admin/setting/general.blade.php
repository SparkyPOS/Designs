                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-4 col-sm-6">
                                <label class="required">
                                    @lang('Commission Percentage')
                                    <i class="fas fa-info-circle text--info" title="@lang('When an order is placed, the system calculates commission by applying the commission percentage to the product price.')"></i>
                                </label>
                                <div class="input-group">
                                    <span class="input-group-text">%</span>
                                    <input type="number"  class="form-control" name="commission_percentage" value="{{ getAmount(gs('commission_percentage')) }}">
                                </div>
                            </div>
                        </div>
