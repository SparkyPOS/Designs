                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="fw-bold">{{ $withdraw?->vendor?->fullname }}</span>
                                    <br>
                                    <span class="small"> <a href="{{ route('admin.vendors.detail', $withdraw?->vendor?->id) }}"><span>@</span>{{ $withdraw?->vendor?->username }}</a> </span>
                                </td>
