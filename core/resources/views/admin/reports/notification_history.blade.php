                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        <td>
                                            ...
                                            @elseif($log->vendor_id)
                                                <span class="fw-bold">{{ $log->vendor->fullname }}</span>
                                                <br>
                                                <span class="small">
                                                    <a href="{{ route('admin.vendors.detail', $log->vendor_id) }}"><span>@</span>{{ $log->vendor->username }}</a>
                                                </span>
                                            @else
...
@elseif(isset($vendor) && $vendor)
        <a href="{{ route('admin.vendors.notification.single',$vendor->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
    @else
