                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            @forelse($transactions as $trx)
                                <tr>
                                    <td>
                                        <span class="fw-bold">{{ $trx->vendor->fullname ?? NULL }}</span>
                                        <br>
                                        <span class="small"> <a href="{{ appendQuery('search',$trx->vendor->username ?? NULL) }}"><span>@</span>{{ $trx->vendor->username ?? NULL }}</a> </span>
                                    </td>
