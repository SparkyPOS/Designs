                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="sms_method" class="select2 form-control" data-minimum-results-for-search="-1">
                                ...
                                <option value="smsBroadcast" @if (isset(gs('sms_config')->name) && gs('sms_config')->name == 'smsBroadcast') selected @endif>@lang('Sms Broadcast')</option>
                                <option value="twilio" @if (isset(gs('sms_config')->name) && gs('sms_config')->name == 'twilio') selected @endif>@lang('Twilio')</option>
                        ...
                        <div class="row mt-4 d-none configForm" id="clickatell">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Key')" name="clickatell_api_key" value="{{ isset(gs('sms_config')->clickatell->api_key) ? gs('sms_config')->clickatell->api_key : '' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4 d-none configForm" id="nexmo">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('API Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('API Key')" name="nexmo_api_key" value="{{ isset(gs('sms_config')->nexmo->api_key) ? gs('sms_config')->nexmo->api_key : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('API Secret') </label>
                                    <input type="text" class="form-control" placeholder="@lang('API Secret')" name="nexmo_api_secret" value="{{ isset(gs('sms_config')->nexmo->api_secret) ? gs('sms_config')->nexmo->api_secret : '' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4 d-none configForm" id="twilio">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Account SID')" name="account_sid" value="{{ isset(gs('sms_config')->twilio->account_sid) ? gs('sms_config')->twilio->account_sid : '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('Auth Token') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Auth Token')" name="auth_token" value="{{ isset(gs('sms_config')->twilio->auth_token) ? gs('sms_config')->twilio->auth_token : '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('From Number') </label>
                                    <input type="text" class="form-control" placeholder="@lang('From Number')" name="from" value="{{ isset(gs('sms_config')->twilio->from) ? gs('sms_config')->twilio->from : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="textMagic">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Username') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Username')" name="text_magic_username" value="{{ isset(gs('sms_config')->text_magic->username) ? gs('sms_config')->text_magic->username : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Apiv2 Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Apiv2 Key')" name="apiv2_key" value="{{ isset(gs('sms_config')->text_magic->apiv2_key) ? gs('sms_config')->text_magic->apiv2_key : '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="custom_api_url" value="{{ isset(gs('sms_config')->custom->url) ? gs('sms_config')->custom->url : '' }}" placeholder="@lang('API URL')">
                                    </div>
                                </div>
                            </div>
                            <hr>
                                        ...
                                        <div class="card-body">
                                            <div class="headerFields">
                                                @for ($i = 0; $i < count(gs('sms_config')->custom->headers->name); $i++)
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_header_name[]" class="form-control" value="{{ isset(gs('sms_config')->custom->headers->name[$i]) ? gs('sms_config')->custom->headers->name[$i] : '' }}" placeholder="@lang('Headers Name')">
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_header_value[]" class="form-control" value="{{ isset(gs('sms_config')->custom->headers->value[$i]) ? gs('sms_config')->custom->headers->value[$i] : '' }}" placeholder="@lang('Headers Value')">
                                                        </div>
                                                        <div class="col-md-2">
                                        ...
                                        <div class="card-body">
                                            <div class="bodyFields">
                                                @for ($i = 0; $i < count(gs('sms_config')->custom->body->name); $i++)
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_body_name[]" class="form-control" value="{{ isset(gs('sms_config')->custom->body->name[$i]) ? gs('sms_config')->custom->body->name[$i] : '' }}" placeholder="@lang('Body Name')">
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_body_value[]" value="{{ isset(gs('sms_config')->custom->body->value[$i]) ? gs('sms_config')->custom->body->value[$i] : '' }}" class="form-control" placeholder="@lang('Body Value')">
                                                        </div>
                                                        <div class="col-md-2">
...
@push('script')
    <script>
        (function($) {
            ...
            $('select[name=custom_api_method]').val(`{{ isset(gs('sms_config')->custom->method) ? gs('sms_config')->custom->method : '' }}`);
