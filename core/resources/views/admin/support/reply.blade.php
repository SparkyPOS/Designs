                    ...
                    <form action="{{ route('admin.ticket.reply', $ticket->id) }}" enctype="multipart/form-data" method="post" class="form-horizontal disableSubmission">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-9">
                                ...
                                <p class="mb-2 fs-16"><span class="text--base-two">
                                        @lang('Max 5 files can be uploaded'). @lang('Maximum upload size is') {{ convertToReadableSize(ini_get('upload_max_filesize')) }} @lang('Allowed File Extensions: .jpg, .jpeg, .png, .pdf, .doc, .docx')</span></p>
                            ...
                            <div class="row border border--primary border-radius-3 my-3 mx-0">
                                <div class="col-md-3 border-end text-md-end text-start">
                                    ...
                                    @elseif ($ticket->vendor_id != null)
                                        <p><a href="{{ route('admin.vendors.detail', $ticket->vendor_id) }}">&#64;{{ $ticket->vendor->username }}</a></p>
                                    @else
