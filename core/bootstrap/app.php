...
use App\Http\Middleware\KycVendorMiddleware;
use App\Http\Middleware\RedirectIfNotVendor;
use Symfony\Component\HttpFoundation\Response;
use App\Http\Middleware\RedirectIfAuthenticated;
use App\Http\Middleware\VendorRegistrationComplete;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'vendor.check.status' => CheckVendorStatus::class,
            'vendor.kyc' => KycVendorMiddleware::class,
            'vendor.registration.complete' => VendorRegistrationComplete::class,
        ]);
