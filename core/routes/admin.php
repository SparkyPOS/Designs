...
Route::middleware('admin')->group(function () {
    ...
    // Vendor Manager
    Route::controller('ManageVendorsController')->name('vendors.')->prefix('vendors')->group(function () {
        Route::get('/', 'allVendors')->name('all');
        Route::get('active', 'activeVendors')->name('active');
        Route::get('banned', 'bannedVendors')->name('banned');
        Route::get('email-verified', 'emailVerifiedVendors')->name('email.verified');
        Route::get('email-unverified', 'emailUnverifiedVendors')->name('email.unverified');
        Route::get('mobile-unverified', 'mobileUnverifiedVendors')->name('mobile.unverified');
        Route::get('kyc-unverified', 'kycUnverifiedVendors')->name('kyc.unverified');
        Route::get('kyc-pending', 'kycPendingVendors')->name('kyc.pending');
        Route::get('mobile-verified', 'mobileVerifiedVendors')->name('mobile.verified');
        Route::get('with-balance', 'vendorsWithBalance')->name('with.balance');
    ...
    // Catalogs
    Route::controller('CatalogController')->prefix('catalogs')->name('catalog.')->group(function () {
        Route::post('/category/{id}/status', 'catalogCategoryStatus')->name('category.status');
        Route::get('/categories', 'catalogCategories')->name('category.list');
        Route::post('/categories/{id?}', 'storeCatalogCategory')->name('category.store');
        Route::get('category/check/slug', 'checkCategorySlug')->name('category.check.slug');
        Route::get('category/seo/{id}', 'categorySeo')->name('category.seo');
        Route::post('category/seo/store/{id}', 'categorySeoStore')->name('category.seo.store');

        Route::get('/', 'catalogs')->name('list');
        Route::post('/store/{id?}', 'storeCatalog')->name('store');
        Route::post('/status/{id}', 'catalogStatus')->name('status');
        Route::get('check/slug', 'checkCatalogSlug')->name('check.slug');
        Route::get('seo/{id}', 'catalogSeo')->name('seo');
        Route::post('seo/store/{id}', 'catalogSeoStore')->name('seo.store');
    });

    Route::controller('DesignerAssetController')->prefix('designer-assets')->name('designer.assets.')->group(function () {
    ...
    // Users Manager
    Route::controller('ManageUsersController')->name('users.')->prefix('customers')->group(function(){
    ...
    Route::controller('OrderController')->prefix('orders')->name('order.')->group(function () {
        ...
        Route::post('payment/returned/{id}', 'paymentReturned')->name('payment.returned');
    });

     // review controller
    Route::controller('ReviewController')->prefix('reviews')->name('reviews.')->group(function(){
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function(){
        ...
        Route::get('login/ipHistory/{ip}', 'loginIpHistory')->name('login.ip.history');
        Route::get('vendor/login/history', 'vendorLoginHistory')->name('vendor.login.history');
        Route::get('vendor/login/ipHistory/{ip}', 'vendorLoginIpHistory')->name('vendor.login.ip.history');
